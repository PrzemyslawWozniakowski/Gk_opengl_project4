...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//====================
		glm::vec3 ballPosition = glm::vec3(2.5 + 2*cos((float)glfwGetTime()), -2.5, -2.5 + 2*sin((float)glfwGetTime()));
...
void processInput(GLFWwindow *window)
{
	...
	if(glfwGetKey(window, GLFW_KEY_B) == GLFW_PRESS || glfwGetKey(window, GLFW_KEY_G) == GLFW_PRESS)
